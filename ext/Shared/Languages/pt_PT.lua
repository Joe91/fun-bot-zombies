...
Language:add(code, "Zombies Drop Nades", "Zumbis derrubam Nades")
Language:add(code, "Zombies drop randomly nades", "Zumbis derrubam nades aleatoriamente")
Language:add(code, "Use Zombie Classes", "Use aulas de zumbis")
...
Language:add(code, "Increment Ammo drop per wave", "Aumentar a queda de munição por onda")
Language:add(code, "Zombies drop more ammo each wave", "Zumbis soltam mais munição a cada onda")
Language:add(code, "Increment Nade drop per wave", "Aumentar a queda de Nade por onda")
Language:add(code, "Zombies drop more nades each wave", "Zumbis derrubam mais nades a cada onda")
Language:add(code, "Max Shoot-Distance", "Distância máxima de disparo")
...
Language:add(code, "Max Shoot-Height", "Altura máxima de tiro")
Language:add(code, "Maximum height when a bot is close. Will scale over distance and will be 0 at the MaxShootDistance", "Altura máxima quando um bot está próximo. Será dimensionado de acordo com a distância e será 0 em MaxShootDistance")
