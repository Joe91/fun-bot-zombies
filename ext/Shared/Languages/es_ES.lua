...
Language:add(code, "Zombies Drop Nades", "Zombis lanzan nades")
Language:add(code, "Zombies drop randomly nades", "Los zombis sueltan nades aleatoriamente.")
Language:add(code, "Use Zombie Classes", "Usa clases de zombies")
Language:add(code, "Zombie classes behave different", "Las clases de zombies se comportan de manera diferente.")
Language:add(code, "Bot Headshot DamageMultiplier", "Multiplicador de daño por disparo en la cabeza del robot")
Language:add(code, "Bot Explosion DamageMultiplier", "Multiplicador de daño de explosión de robot")
Language:add(code, "Damage multiplier for explosions ", "Multiplicador de daño por explosiones.")
Language:add(code, "Increment Ammo drop per wave", "Incrementar la caída de munición por oleada")
Language:add(code, "Zombies drop more ammo each wave", "Los zombis sueltan más munición en cada oleada.")
Language:add(code, "Increment Nade drop per wave", "Incrementar la caída de Nade por onda")
Language:add(code, "Zombies drop more nades each wave", "Los zombis sueltan más nades en cada ola.")
Language:add(code, "Max Shoot-Distance", "Distancia máxima de disparo")
Language:add(code, "Meters before bots will start shooting at players", "Metros antes de que los robots comiencen a disparar a los jugadores.")
Language:add(code, "Max Shoot-Height", "Altura máxima de disparo")
Language:add(code, "Maximum height when a bot is close. Will scale over distance and will be 0 at the MaxShootDistance", "Altura máxima cuando un bot está cerca. Escalará según la distancia y será 0 en MaxShootDistance")
