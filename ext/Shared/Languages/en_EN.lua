...
Language:add(code, "Zombie classes behave different", "Zombie classes behave different")
Language:add(code, "Bot Headshot DamageMultiplier", "Bot Headshot DamageMultiplier")
Language:add(code, "Bot Explosion DamageMultiplier", "Bot Explosion DamageMultiplier")
Language:add(code, "Damage multiplier for explosions ", "Damage multiplier for explosions")
Language:add(code, "Increment Ammo drop per wave", "Increment Ammo drop per wave")
Language:add(code, "Zombies drop more ammo each wave", "Zombies drop more ammo each wave")
Language:add(code, "Increment Nade drop per wave", "Increment Nade drop per wave")
Language:add(code, "Zombies drop more nades each wave", "Zombies drop more nades each wave")
