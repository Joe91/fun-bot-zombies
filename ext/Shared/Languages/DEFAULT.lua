...
Language:add(code, "Zombies Drop Nades", "")
Language:add(code, "Zombies drop randomly nades", "")
Language:add(code, "Use Zombie Classes", "")
Language:add(code, "Zombie classes behave different", "")
...
Language:add(code, "Bot Headshot DamageMultiplier", "")
Language:add(code, "Damage multiplier for shooting bots in the head", "")
Language:add(code, "Bot Explosion DamageMultiplier", "")
Language:add(code, "Damage multiplier for explosions ", "")
...
Language:add(code, "Zombies get more speed each wave", "")
Language:add(code, "Increment Ammo drop per wave", "")
Language:add(code, "Zombies drop more ammo each wave", "")
Language:add(code, "Increment Nade drop per wave", "")
Language:add(code, "Zombies drop more nades each wave", "")
...
Language:add(code, "Max Shoot-Distance", "")
Language:add(code, "Meters before bots will start shooting at players", "")
Language:add(code, "Max Shoot-Height", "")
Language:add(code, "Maximum height when a bot is close. Will scale over distance and will be 0 at the MaxShootDistance", "")
